...
<div class="container">
    ...
    <table class="bloco-container" align="center" cellpadding="0" cellspacing="0">
        ...
        <tr>
            ...
            <td class="bloco" style="width: 20%;{{$totalBlocos <= 2 ? 'margin-left:2%;' : 'margin-left:2%;'}}">
                ...
                <table width="100%">
                    ...
                    @if($desconto == 1)
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="valor-copart-laranja">Desc.{{intval($valor_desconto)}}%</div>
                            </td>
            ...
            @if($com_coparticipacao == 1)
                ...
                <td class="bloco" style="width: 35%; margin: {{ $margins[$totalBlocos] }};">
            ...
            @if($sem_coparticipacao == 1)
                ...
                <td class="bloco" style="width: 35%;{{$totalBlocos <= 2 ? 'margin-left:1%;' : 'margin-left:0%;'}} ">
